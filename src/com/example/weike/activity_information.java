    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	backforward.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(activity_information.this,main.class);
    	...
    	listView_courses.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?>  parent, View view, int position,
					long id) {
				Toast.makeText(activity_information.this, "点击了"+listView_courses.getItemAtPosition(position).toString(), Toast.LENGTH_SHORT).show();
			}
